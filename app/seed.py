...
SAMPLE_CONTACTS = [
    ContactCreate(
        ...
        addresses=[
            ...
            AddressCreate(type=AddressType.HOME, street="12 Hanover Sq", city="London", country="UK"),
        ],
    ...
    ContactCreate(
        ...
        addresses=[
            AddressCreate(
                type=AddressType.WORK, street="1 Navy Yard", city="Arlington", state="VA", country="USA"
            )
        ],
    ),
    ContactCreate(
        ...
        addresses=[
            AddressCreate(type=AddressType.OTHER, street="The Mansion", city="Milton Keynes", country="UK")
        ],
    ),
]
